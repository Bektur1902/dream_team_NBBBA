...
class Database:
    ...
    def genders(self):
        ...
        for item in self.name:
            for j in item:
                gender_tuple.append(item['gender'])
        return tuple(gender_tuple)
...
object = Database(user_data)
print(object.genders())
print(object.get_domain())